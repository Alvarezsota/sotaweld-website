...
const InvoicePreview = (function () {
   ...
   *
   *   There was a third, for the quote desk's own invoices. Those became Parts
   *   and Services invoices and the table behind them is gone, so asking the
   *   push for one now would reach a payload function that no longer exists.
   *   The way in is closed rather than left to be found.
